import java.io.*;
import java.net.*;
public class UDPTemperaturClient {
    public static void main(String[] args) throws IOException {

        //Die von Server kommende Daten wird in BufferedReader gehalten.
        ...
        while (true){
            System.out.println("Temperatur : Geben Sie eine Nachricht ein, die der Server erhalten soll. " );
            //
